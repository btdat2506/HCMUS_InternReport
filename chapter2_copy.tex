...
%\begin{figure}[htbp] ... \caption{Sơ đồ khối DMA Controller.} \label{fig:dma_block_diagram_mermaid} ... \end{figure}
%\begin{figure}[htbp] ... \caption{Sơ đồ luồng hoạt động DMA.} \label{fig:dma_flowchart_pdf} ... \end{figure}
%\begin{figure}[htbp] ... \caption{Sơ đồ tuần tự DMA.} \label{fig:dma_sequence_diagram_pdf} ... \end{figure}
...
%\begin{figure}[htbp] ... \caption{Sơ đồ máy trạng thái Control Slave.} \label{fig:control_slave_fsm_pdf} ... \end{figure}
% --- End Placeholder Figure ---
...
%\begin{figure}[htbp] ... \caption{Sơ đồ máy trạng thái Read Master.} \label{fig:read_master_fsm_pdf} ... \end{figure}
% --- End Placeholder Figure ---
...
%\begin{figure}[htbp] ... \caption{Sơ đồ máy trạng thái Write Master.} \label{fig:write_master_fsm_pdf} ... \end{figure}
% --- End Placeholder Figure ---
...
% --- Bảng tín hiệu DMA ---
% --- Suggestion for Table 2.1 if it causes "Float too large" error:
% --- Option 1: Use smaller font inside table
% {\small % or \footnotesize
% \begin{table}[htbp] ... \end{table}
% }
% --- Option 2: Adjust column widths (e.g., change p{7cm} to p{6cm} or similar)
% --- Option 3: Use longtable (requires \usepackage{longtable})
% \begin{longtable}{@{}ccccp{7cm}@{}} ... \end{longtable} (replaces table+tabular)
\begin{table}[htbp]
    \centering
...
        6 & \texttt{iAddress} & In & 3 & Chọn địa chỉ của thanh ghi cần đọc/ghi (offset word) \\ % Adjusted description
...
% Figures 02_07 and 02_08 side-by-side
\begin{figure}[htbp]
    \centering
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
