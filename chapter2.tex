...
% --- Nhớ chèn các môi trường \begin{figure}...\end{figure} cho các sơ đồ vào đây ---
% Ví dụ:
% \begin{figure}[htbp] ... \label{fig:dma_block_diagram_mermaid} ... \end{figure}
% \begin{figure}[htbp] ... \label{fig:control_slave_fsm_pdf} ... \end{figure}
% \begin{figure}[htbp] ... \label{fig:read_master_fsm_pdf} ... \end{figure}
% \begin{figure}[htbp] ... \label{fig:write_master_fsm_pdf} ... \end{figure}
% \begin{figure}[htbp] ... \label{fig:dma_sequence_diagram_pdf} ... \end{figure}
% \begin{figure}[htbp] ... \label{fig:dma_flowchart_pdf} ... \end{figure}
% --- Kết thúc phần thêm figure ---
